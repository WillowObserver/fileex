...
public class Pdf2Img {
                ...
                if(testDir.isDirectory()){
                    ...
                    for (String file : files) {
                        ...
                        if (file.toLowerCase().endsWith(".pdf"))
                            new Pdf2Img(fileType, pdfFile + file,"");
                    }
                }else
     ...
     * @throws Exception
     */
    public Pdf2Img(String fileType, String pdfFile,String filename) throws Exception {
...
//        FontMappings.setFontReplacements();
        ...
        System.out.println( decoder.getPageCount());
        /**
        ...
        try{
            ...
            if(separation!=null){
                ...
                for(int seps=0;seps<sepCount;seps=seps+3){
                    ...
                    extractPageAsImage(fileType, outputPath, decoder,"_"+sepValues[seps+1], (Boolean) sepValues[seps + 2],filename); //boolean makes last transparent so we can see white text
                }

            }else //just get the page
                extractPageAsImage(fileType, outputPath, decoder,"",false,filename);
...
//            FontMappings.setFontReplacements();
     ...
     * @throws IOException
     */
    private void extractPageAsImage(String fileType, String outputPath, PdfDecoder decoder, String prefix, boolean isTransparent,String filename) throws PdfException, IOException {
        ...
        for (int pageNo = start; pageNo < end+1; pageNo++) {
            ...
            /**
             * example2 handler which will ask JPedal to time out and return from decoding
             * will reset after exit so call for each page
             */
            /**
             Thread a=new Thread(){
             ...
             * PdfDecoder.modifyJPedalParameters(), then getPageAsHiRes() wont necessarily be handler safe.  If you want to use
             * getPageAsHiRes() and pass in additional parameters, in a handler safe mannor, please use the method
            ...
            if(isSingleOutputFile)
                outputFileName = outputPath+filename+"_"+prefix+ '.' + fileType;
            else{
                /**
                ...
                outputFileName = outputPath+filename +"_"+ pageAsString +prefix + '.' + fileType;
            }
