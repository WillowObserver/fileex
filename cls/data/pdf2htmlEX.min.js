...
'use strict';
var samtemp='<div id="tools" style="text-align:center;background-color:#000;color:#fff;font-size:15px;z-index:10000;position:fixed;width:100%;top:0"><span id="scaleSelectContainer" style="min-width:82px;max-width:82px"><select id="scaleSelect" onchange="fnscaleSelect(this);"  title="缩放" tabindex="23" style="min-width:104px"><option value="1">实际大小</option><option title="" value="page-fit">适合页面</option><option title="" value="0.5">50%</option><option title="" value="0.75">75%</option><option title="" value="1">100%</option><option title="" value="1.25">125%</option><option title="" value="1.5">150%</option><option title="" value="2">200%</option><option title="" value="3">300%</option><option title="" value="4">400%</option></select></span></div>';
function fnscaleSelect(sel){
	...
	if(val!="page-fit"){
		...
		pdf2htmlEX.defaultViewer.rescale(parseFloat(val));
...
// 自定义函数向后插入
function SAM_insertAfter( newElement, targetElement)
{
...
function Viewer(config) {
	 try{
         ...
         document.getElementsByTagName("link")[2].href=document.getElementsByTagName("link")[2].href+location.search;   
	  }catch(e){};
  ...
  document.addEventListener('DOMContentLoaded', function(){
	   var div=document.createElement("div");
		  div.innerHTML=samtemp;
	  SAM_insertAfter(div,document.getElementById("sidebar"));
...
Viewer.prototype = {
  ...
  init_after_loading_content : function() {
    ...
    this.render();
	setTimeout(function(){if(detectmob()){
		document.getElementById("scaleSelect").selectedIndex=1;
	 pdf2htmlEX.defaultViewer.fit_width();	
	} },1000)
  },
        ...
        xhr.onload = function(){
          ...
          var imgs=div.getElementsByTagName("img");
		   for(var i=0;i<imgs.length;i++){
			    imgs[i].setAttribute("src",imgs[i].getAttribute("src")+location.search);
